...
public class TestCreateWithFiles extends AbstractIntegrationTest{
    ...
    public void test_create_with_files() {
        ...
        assert bootstrapFile.text.equals(new File("build/testBuilds/test-create-with-files/src/main/liberty/config/bootstrap.properties").text) : "bootstrap.test.properties file did not copy properly"
