...
class LibertyPackage_archiveJar_dirWithSpaceTest extends AbstractIntegrationTest{
    static File resourceDir = new File("build/resources/test/liberty-package-test")
    static File buildDir = new File(integTestDir, "/liberty-package-archiveJar-with-space-test")
    static File packageDir = new File(buildDir, "/folder with space")

    static File buildFilename = new File(resourceDir, "liberty-package-archiveJar-dirWithSpace.gradle")
