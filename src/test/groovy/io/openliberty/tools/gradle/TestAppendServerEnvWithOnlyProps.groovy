...
class TestAppendServerEnvWithOnlyProps extends AbstractIntegrationTest {
    static File resourceDir = new File("build/resources/test/sample.servlet")
    static File buildDir = new File(integTestDir, "/test-append-server-env-with-only-props")
    static String buildFilename = "testAppendServerEnvWithOnlyEnvProps.gradle"
    ...
    public void check_for_server_env() {
        assert new File('build/testBuilds/test-append-server-env-with-only-props/build/wlp/usr/servers/LibertyProjectServer/server.env').exists() : 'server.env not found!'
    }
    ...
    */
    ...
    public void check_server_env_contents() {
        File serverEnv = new File("build/testBuilds/test-append-server-env-with-only-props/build/wlp/usr/servers/LibertyProjectServer/server.env")
