    ...
    public void test_loose_config_file_exists() {
        try {
            ...
            Assert.assertTrue("Toolchain skipped message missing in task output",
                    result.getOutput()
                            .contains("CWWKM4101W: The toolchain JDK configuration for task :libertyCreate is not honored because the JAVA_HOME property is specified in the server.env or jvm.options file."))
        } catch (Exception e) {
