...
public class TestCompileJSPSource17Jakarta extends AbstractIntegrationTest{
    static File resourceDir = new File("build/resources/test/sampleJSP.servlet")
    static File buildDir = new File(integTestDir, "/test-compile-jsp-source-17-jakarta")
    static String buildFilename = "testCompileJSP17Jakarta.gradle"
    ...
    public void check_for_jsp() {
        assert new File('build/testBuilds/test-compile-jsp-source-17-jakarta/src/main/webapp/index.jsp').exists() : 'index.jsp not found!'
    }

    @Test
    public void test_1() {
        
        assert new File('build/testBuilds/test-compile-jsp-source-17-jakarta/build/compileJsp').exists() : 'compileJsp Directory not found!'
    }

    @Test
    public void test_2() {
        assert new File('build/testBuilds/test-compile-jsp-source-17-jakarta/build/classes/java/_index.class').exists() : '_index.class not found!'
    }

    @Test
    public void check_jsp_server_xml_exists() {
        assert new File('build/testBuilds/test-compile-jsp-source-17-jakarta/build/compileJsp/servers/defaultServer/server.xml').exists() : 'server.xml not found!'
    }

    @Test
    public void check_jsp_server_xml_contains_features() {
        File serverXml = new File("build/testBuilds/test-compile-jsp-source-17-jakarta/build/compileJsp/servers/defaultServer/server.xml")
        ...
        Assert.assertTrue("servlet-6.0 <feature/> found ==>", features.contains("servlet-6.0"))
