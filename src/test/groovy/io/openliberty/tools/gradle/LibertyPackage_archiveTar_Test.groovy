...
class LibertyPackage_archiveTar_Test extends AbstractIntegrationTest{
    static File resourceDir = new File("build/resources/test/liberty-package-test")
    static File buildDir = new File(integTestDir, "/liberty-package-archiveTar-test")
    static File buildFilename = new File(resourceDir, "liberty-package-archiveTar.gradle")
    ...
    public void test_package_archiveTar() {
        try{
           ...
           def file = new File(buildDir, 'build/libs/testPackage.tar')
