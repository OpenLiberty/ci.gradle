...
class TestAppendServerEnvWithConfigServerEnv extends AbstractIntegrationTest {
    ...
    */
    ...
    public void check_server_env_contents() {
        ...
        Assert.assertTrue("Number of env properties should be >= 4, but is "+serverEnvContents.size(),  	serverEnvContents.size() >= 4)
        ...
        Assert.assertTrue("TEST_PROP_2=green", serverEnvContents.get("TEST_PROP_2").equals("green"))
    }
