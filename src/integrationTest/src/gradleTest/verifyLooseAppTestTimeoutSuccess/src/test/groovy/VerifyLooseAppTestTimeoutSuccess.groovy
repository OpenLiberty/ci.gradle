...
public class VerifyLooseAppTestTimeoutSuccess {
    def projectDir = new File('.')

    @Test
    public void test_loose_config_file_exists() {
        assert new File(projectDir, 'build/wlp/usr/servers/LibertyProjectServer/apps/sample.servlet.war.xml').exists() : 'looseApplication config file was not copied over to the liberty runtime'
    }
/*
...
*/
    ...
    public void test_loose_config_file_contents_are_correct(){
      File on = new File(projectDir, "build/wlp/usr/servers/LibertyProjectServer/apps/sample.servlet.war.xml");
