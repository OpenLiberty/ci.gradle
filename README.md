...
- **Gradle 7.6 / 8.x** works with Java 8, 11, 17, or 21 and plugin version **3.8.2** or later, but it is **not compatible** with **4.0.0** or higher versions within the **4.x** series.
